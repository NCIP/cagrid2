...
public class UMLAttributeMetadata  implements Serializable
{
	...
	**/
	...
	public void setFullyQualifiedName(String fullyQualifiedName){
		...
		/**
	* the XML schema tag name in the schema registered in caGrid Global Model Exchange assigned to the attribute in a UML Model representing the location of the attribute in the xml element 
	**/
