...
import java.util.Collection;import gov.nih.nci.cadsr.umlproject.domain.UMLAssociationMetadata;import gov.nih.nci.cadsr.umlproject.domain.UMLGeneralizationMetadata;
...
public class ObjectClassRelationship extends AdministeredComponent implements Serializable
{
	...
	**/
	...
	private Collection<UMLGeneralizationMetadata> generalizationMetadata;
	/**
	* Retreives the value of generalizationMetadata attribue
	* @return generalizationMetadata
	**/

	public Collection<UMLGeneralizationMetadata> getGeneralizationMetadata(){
		return generalizationMetadata;
	}

	/**
	* Sets the value of generalizationMetadata attribue
	**/

	public void setGeneralizationMetadata(Collection<UMLGeneralizationMetadata> generalizationMetadata){
		this.generalizationMetadata = generalizationMetadata;
	}
	...
	**/
	...
	private Collection<UMLAssociationMetadata> associationMetadata;
	/**
	* Retreives the value of associationMetadata attribue
	* @return associationMetadata
	**/

	public Collection<UMLAssociationMetadata> getAssociationMetadata(){
		return associationMetadata;
	}

	/**
	* Sets the value of associationMetadata attribue
	**/

	public void setAssociationMetadata(Collection<UMLAssociationMetadata> associationMetadata){
