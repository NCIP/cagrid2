...
public class Concept extends AdministeredComponent implements Serializable
{
	...
	**/
	...
	private Collection<SemanticMetadata> semanticMetadata;
	/**
	* Retreives the value of semanticMetadata attribue
	* @return semanticMetadata
	**/

	public Collection<SemanticMetadata> getSemanticMetadata(){
		return semanticMetadata;
	}

	/**
	* Sets the value of semanticMetadata attribue
	**/

	public void setSemanticMetadata(Collection<SemanticMetadata> semanticMetadata){
