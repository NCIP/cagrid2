...
public class DataElement extends AdministeredComponent implements Serializable
{
	...
	**/
	...
	private Collection<UMLAttributeMetadata> attributeMetadata;
	/**
	* Retreives the value of attributeMetadata attribue
	* @return attributeMetadata
	**/

	public Collection<UMLAttributeMetadata> getAttributeMetadata(){
		return attributeMetadata;
	}

	/**
	* Sets the value of attributeMetadata attribue
	**/

	public void setAttributeMetadata(Collection<UMLAttributeMetadata> attributeMetadata){
