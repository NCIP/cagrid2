...
/**
 * <p>Java class for BasicAuthenticationCredential complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BasicAuthenticationCredential">
 *   &lt;complexContent>
...
@XmlType(name = "BasicAuthenticationCredential", propOrder = {
    "userId",
    "password"
})
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof BasicAuthenticationCredential)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final BasicAuthenticationCredential that = ((BasicAuthenticationCredential) object);
        {
            String lhsUserId;
