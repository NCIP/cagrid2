...
public class DorianUserCredentialEntry extends X509CredentialEntry {
	...
	public DorianUserCredentialEntry(DorianUserCredentialDescriptor des)
			throws Exception {
		super(des);
		this.descriptor = des;
	}
	...
	public String getDisplayName() {
		if ((this.descriptor.getFirstName() == null)
				|| (this.descriptor.getLastName() == null)
				|| (this.descriptor.getOrganization() == null)) {
			return getIdentity();
		} else {
			return this.descriptor.getFirstName() + " "
					+ this.descriptor.getLastName() + " ("
