...
{
	protected final static Logger logger = LoggerFactory.getLogger(SAMLStatement.class);
    ...
    public static SAMLStatement getInstance(Element e) throws SAMLException {
        ...
        try
        {
            ...
            {
                String className = (String)statementTypeMap.get(XML.getQNameAttribute(e, XML.XSI_NS, "type"));
                if (className == null)
    ...
    public static SAMLStatement getInstance(InputStream in) throws SAMLException {
        ...
        {
        	logger.error("SAMLStatement.getInstance() caught exception while parsing a stream",e);
