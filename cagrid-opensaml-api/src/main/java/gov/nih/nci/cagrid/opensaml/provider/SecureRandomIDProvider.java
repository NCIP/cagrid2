...
import gov.nih.nci.cagrid.opensaml.SAMLIdentifier;
...
public class SecureRandomIDProvider implements SAMLIdentifier
{
    ...
    /**
     * @see gov.nih.gov.nih.nci.cagrid.opensaml.SAMLIdentifier#getIdentifier()
     */
    ...
    /**
     * @see gov.nih.gov.nih.nci.cagrid.opensaml.SAMLIdentifier#generateRandomBytes(java.security.SecureRandom, int)
     */
    ...
    /**
     * @see gov.nih.gov.nih.nci.cagrid.opensaml.SAMLIdentifier#generateRandomBytes(int)
     */
