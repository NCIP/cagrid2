...
{
	private final static Logger logger = LoggerFactory.getLogger(SAMLCondition.class);
        ...
        throws SAMLException
    {
        ...
        {
            logger.error("SAMLCondition.getInstance() caught exception while parsing a stream",e);
