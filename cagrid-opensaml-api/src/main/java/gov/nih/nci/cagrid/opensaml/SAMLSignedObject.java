...
public abstract class SAMLSignedObject extends SAMLObject implements Cloneable
{
    ...
    /**
     * @see gov.nih.gov.nih.nci.cagrid.opensaml.SAMLObject#fromDOM(Element e)
     */
    ...
    /**
     * @see gov.nih.gov.nih.nci.cagrid.opensaml.SAMLObject#toDOM(boolean xmlns)
     */
    ...
    /**
     * @see gov.nih.gov.nih.nci.cagrid.opensaml.SAMLObject#setDirty()
     */
