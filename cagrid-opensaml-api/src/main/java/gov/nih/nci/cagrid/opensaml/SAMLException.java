...
{
	private final static Logger sLogger = LoggerFactory.getLogger(SAMLException.class);
    ...
    public static SAMLException getInstance(Element e) throws SAMLException {
        ...
        try {
        	...
        	sLogger.error("SAMLException: unable to locate implementation class for exception", ex);
        }
        catch (NoSuchMethodException ex) {
        	sLogger.error("SAMLException: unable to bind to constructor for exception", ex);
        }
        catch (InstantiationException ex) {
        	sLogger.error("SAMLException: unable to build implementation object for exception", ex);
        }
        catch (IllegalAccessException ex) {
        	sLogger.error("SAMLException: unable to access implementation of exception", ex);
        }
        catch (java.lang.reflect.InvocationTargetException ex) {
        	sLogger.error("SAMLException: caught unknown exception while building exception object", ex);
        }
    ...
    public static SAMLException getInstance(InputStream in) throws SAMLException {
        try {
            ...
            sLogger.error("SAMLException.getInstance() caught exception while parsing a stream",e);
     ...
     * @throws SAMLException    Raised if this object already has a parent
     */
    ...
    public void fromDOM(Element e) throws SAMLException {
        ...
        if (config.getBooleanProperty("gov.nih.nci.cagrid.opensaml.strict-dom-checking") && !XML.isElementNamed(e,XML.SAMLP_NS,"Status"))
