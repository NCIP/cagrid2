...
{
	private final static Logger sLogger = LoggerFactory.getLogger(SAMLQuery.class);
        ...
        throws SAMLException
    {
        ...
        {
            sLogger.error("SAMLQuery.getInstance() caught exception while parsing a stream",e);
