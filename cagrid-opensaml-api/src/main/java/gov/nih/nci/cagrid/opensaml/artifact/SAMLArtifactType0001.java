...
/* 
 * File:  SAMLArtifactType0001.java
 *
 */
...
public class SAMLArtifactType0001 extends SAMLArtifact {
   ...
   *
   * @see SAMLArtifactType0001.RemainingArtifact
   * @see gov.nih.gov.nih.nci.cagrid.opensaml.artifact.NullArgumentException
   * @see gov.nih.gov.nih.nci.cagrid.opensaml.artifact.InvalidArgumentException
   */
  ...
  public static final class Parser implements Artifact.Parser {
     ...
     *
     * @exception gov.nih.gov.nih.nci.cagrid.opensaml.artifact.ArtifactParseException
