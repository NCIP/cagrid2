...
{
	private final static Logger sLogger = LoggerFactory.getLogger(SAMLNameIdentifier.class);
        ...
        throws SAMLException
    {
        try {
            ...
            sLogger.error("SAMLNameIdentifier.getInstance() caught exception while parsing a stream",e);
    ...
    public void fromDOM(Element e) throws SAMLException {
        ...
        if (config.getBooleanProperty("gov.nih.nci.cagrid.opensaml.strict-dom-checking") && !XML.isElementNamed(e,XML.SAML_NS,"NameIdentifier"))
