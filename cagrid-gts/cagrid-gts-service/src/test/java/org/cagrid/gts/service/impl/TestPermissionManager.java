...
public class TestPermissionManager extends TestCase {
    ...
    public void testRevokeNonExistingPermission() {
        ...
        try {
            ...
            } catch (InvalidPermissionException f) {
    ...
    public void testAddInvalidPermissions() {
        ...
        try {
            ...
            try {
                Permission p2 = new Permission();
                p2.setGridIdentity("O=Test Organization,OU=Test Unit,CN=User");
                p2.setRole(Role.TRUST_SERVICE_ADMIN);
                pm.addPermission(p2);
            ...
            try {
                ...
                p3.setRole(Role.TRUST_SERVICE_ADMIN);
                pm.addPermission(p3);
            ...
            try {
                ...
                p5.setRole(Role.TRUST_AUTHORITY_MANAGER);
                pm.addPermission(p5);
            ...
            try {
                ...
                p6.setRole(Role.TRUST_AUTHORITY_MANAGER);
            ...
            try {
                ...
                p7.setRole(Role.TRUST_SERVICE_ADMIN);
    ...
    public void testFindPermissions() {
        ...
        try {
            ...
            for (int i = 0; i < count; i++) {
                ...
                perms1[i].setRole(Role.TRUST_SERVICE_ADMIN);
                ...
                perms2[i].setRole(Role.TRUST_AUTHORITY_MANAGER);
                ...
                f2.setRole(Role.TRUST_SERVICE_ADMIN);
                assertEquals(((i + 1)), pm.findPermissions(f2).length);
                f2.setRole(Role.TRUST_AUTHORITY_MANAGER);
                assertEquals(((i + 1)), pm.findPermissions(f2).length);
