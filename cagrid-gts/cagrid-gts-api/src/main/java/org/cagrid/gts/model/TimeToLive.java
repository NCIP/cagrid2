...
/**
 * <p>Java class for TimeToLive complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TimeToLive">
 *   &lt;complexContent>
...
@XmlType(name = "TimeToLive", propOrder = {
    "hours",
    "minutes",
    "seconds"
})
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TimeToLive)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TimeToLive that = ((TimeToLive) object);
        {
            int lhsHours;
