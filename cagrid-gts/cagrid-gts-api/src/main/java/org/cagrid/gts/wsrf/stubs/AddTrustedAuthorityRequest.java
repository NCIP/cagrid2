...
@XmlRootElement(name = "AddTrustedAuthorityRequest")
public class AddTrustedAuthorityRequest
    implements Serializable, Equals, HashCode, ToString
{

    @XmlElement(required = true)
    protected AddTrustedAuthorityRequest.Ta ta;
     ...
     * @return
     *     possible object is
     *     {@link AddTrustedAuthorityRequest.Ta }
     *     
     */
    public AddTrustedAuthorityRequest.Ta getTa() {
        return ta;
    }
     ...
     *     
     */
    public void setTa(AddTrustedAuthorityRequest.Ta value) {
        this.ta = value;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            AddTrustedAuthorityRequest.Ta theTa;
            theTa = this.getTa();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AddTrustedAuthorityRequest)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AddTrustedAuthorityRequest that = ((AddTrustedAuthorityRequest) object);
        {
            AddTrustedAuthorityRequest.Ta lhsTa;
            lhsTa = this.getTa();
            AddTrustedAuthorityRequest.Ta rhsTa;
            rhsTa = that.getTa();
        ...
        implements Serializable, Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof AddTrustedAuthorityRequest.Ta)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final AddTrustedAuthorityRequest.Ta that = ((AddTrustedAuthorityRequest.Ta) object);
            {
