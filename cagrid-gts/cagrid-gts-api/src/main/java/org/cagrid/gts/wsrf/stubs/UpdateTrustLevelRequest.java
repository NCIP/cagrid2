    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            UpdateTrustLevelRequest.TrustLevel theTrustLevel;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UpdateTrustLevelRequest)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UpdateTrustLevelRequest that = ((UpdateTrustLevelRequest) object);
        {
            UpdateTrustLevelRequest.TrustLevel lhsTrustLevel;
            lhsTrustLevel = this.getTrustLevel();
            UpdateTrustLevelRequest.TrustLevel rhsTrustLevel;
        ...
        implements Serializable, Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof UpdateTrustLevelRequest.TrustLevel)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final UpdateTrustLevelRequest.TrustLevel that = ((UpdateTrustLevelRequest.TrustLevel) object);
            {
