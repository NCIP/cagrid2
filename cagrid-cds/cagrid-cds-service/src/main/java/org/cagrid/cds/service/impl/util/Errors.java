...
//	}
//
	public static PermissionDeniedException getPermissionDeniedFault() {
		return getPermissionDeniedFault(PERMISSION_DENIED);
	}

	public static PermissionDeniedException getPermissionDeniedFault(String error) {
        return Errors.makeException(PermissionDeniedException.class, error);
	}
