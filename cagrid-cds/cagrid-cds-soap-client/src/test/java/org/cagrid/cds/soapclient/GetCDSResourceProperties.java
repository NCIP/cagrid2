...
public class GetCDSResourceProperties extends CDSClientBase {
	...
	public static void main(String[] args) throws Exception {
		...
		Collection<ResourcePropertyDescriptor> resourcePropertyDescriptors = getResourcePropertyDescriptors(CredentialDelegationServiceResourceProperties.class);

		GetCDSResourceProperties me = new GetCDSResourceProperties(
				LOCAL_URL, resourcePropertyDescriptors);
	...
	private void getProperty(QName propertyQName) throws Exception {
		GetResourcePropertyResponse getResourcePropertyResponse = cds
