...
public class CDSWSRFImpl extends CredentialDelegationServicePortTypeImpl {
    ...
    @Override
    public UpdateDelegatedCredentialStatusResponse updateDelegatedCredentialStatus(UpdateDelegatedCredentialStatusRequest parameters) throws DelegationFaultFaultMessage , CDSInternalFaultFaultMessage , PermissionDeniedFaultFaultMessage    {
    ...
    @Override
    public SearchDelegatedCredentialAuditLogResponse searchDelegatedCredentialAuditLog(SearchDelegatedCredentialAuditLogRequest parameters) throws DelegationFaultFaultMessage , CDSInternalFaultFaultMessage , PermissionDeniedFaultFaultMessage    {
        String message = "searchDelegatedCredentialAuditLog";
        logger.debug(message);
        try {
            List<DelegatedCredentialAuditRecord> records = cds.searchDelegatedCredentialAuditLog(getCallerId(), parameters.getF().getDelegatedCredentialAuditFilter());
    ...
    private ResourceKey getResourceKey(DelegationIdentifier id) throws Exception {
		...
		ResourceKey key = new SimpleResourceKey(new QName("http://cds.gaards.cagrid.org/CredentialDelegationService/DelegatedCredential", "DelegatedCredentialKey"), id);
		return key;
	}
