...
public class GridGrouperSoapClientFactory {
	...
	public static GridGrouperPortType createSoapClient(String url) {
		...
		GridGrouperPortType gridGrouperPort = gridGrouperService.getGridGrouperPortTypePort();
	...
	public static GridGrouperPortType createSoapClient(String url,
        ...
        GridGrouperPortType grouperPort = createSoapClient(url);

		Client dorianClient = ClientProxy.getClient(grouperPort);
