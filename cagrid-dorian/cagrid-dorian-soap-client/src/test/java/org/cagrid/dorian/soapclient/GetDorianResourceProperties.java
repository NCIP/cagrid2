...
public class GetDorianResourceProperties extends DorianClientBase {
	...
	public static void main(String[] args) throws Exception {
		...
		Collection<ResourcePropertyDescriptor> resourcePropertyDescriptors = getResourcePropertyDescriptors(DorianResourceProperties.class);

		GetDorianResourceProperties me = new GetDorianResourceProperties(
				LOCALS_URL, resourcePropertyDescriptors);
	...
	private void getProperty(QName propertyQName) throws Exception {
		GetResourcePropertyResponse getResourcePropertyResponse = dorian
