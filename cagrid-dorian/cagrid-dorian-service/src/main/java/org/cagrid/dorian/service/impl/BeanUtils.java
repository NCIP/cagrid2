...
public class BeanUtils {
	...
	public BeanUtils(AbstractResource dorianConf,
			AbstractResource dorianProperties) throws Exception {
	...
	public DorianProperties getDorianProperties() throws Exception {
		DorianProperties props = (DorianProperties) factory
				.getBean(DorianConstants.DORIAN_PROPERTIES_BEAN);
		return props;
	}
	...
	public EventManager getEventManager() throws Exception {
		return (EventManager) factory
				.getBean(DorianConstants.EVENT_MANAGER_BEAN);
	}

	public TrustedIdPManager getTrustedIdPManager() throws Exception {
		return (TrustedIdPManager) factory
				.getBean(DorianConstants.TRUSTED_IDP_MANAGER_BEAN);
	}

	public IdentityProviderProperties getIdentityProviderProperties()
			throws Exception {
		return (IdentityProviderProperties) factory
				.getBean(DorianConstants.IDP_PROPERTIES_BEAN);
	}

	public AssertionCredentialsManager getAssertionCredentialsManager()
			throws Exception {
		return (AssertionCredentialsManager) factory
				.getBean(DorianConstants.IDP_ASSERTION_MANAGER_BEAN);
	}

	public org.cagrid.dorian.idp.impl.UserManager getIdPUserManager()
			throws Exception {
		return (org.cagrid.dorian.idp.impl.UserManager) factory
				.getBean(DorianConstants.IDP_USER_MANAGER_BEAN);
	}
	...
	public CertificateAuthorityProperties getCertificateAuthorityProperties()
		...
		return (CertificateAuthorityProperties) factory
				.getBean(DorianConstants.CA_PROPERTIES_BEAN);
