...
/**
 * <p>Java class for GridUserRecord complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GridUserRecord">
 *   &lt;complexContent>
...
@XmlType(name = "GridUserRecord", propOrder = {
    "identity",
    "firstName",
    "lastName",
    "email"
})
public class GridUserRecord
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GridUserRecord)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GridUserRecord that = ((GridUserRecord) object);
        {
            String lhsIdentity;
