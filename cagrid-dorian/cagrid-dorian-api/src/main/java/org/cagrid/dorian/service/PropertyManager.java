...
public class PropertyManager {
    ...
    public static String CURRENT_VERSION = DORIAN_VERSION_1_6;
    private MetadataManager manager;
    private Metadata version;
    private Metadata certificateAuthorityType;


    public PropertyManager(Database db) throws DorianInternalException {
    ...
    public void setCertificateAuthorityType(String caType) throws DorianInternalException {
    ...
    public void setCurrentVersion() throws DorianInternalException {
        this.setVersion(CURRENT_VERSION);
    }


	public void setVersion(String version) throws DorianInternalException {
