    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            theNamespaceURI = this.getNamespaceURI();
            strategy.appendField(locator, this, "namespaceURI", buffer, theNamespaceURI);
        }
        {
            String theName;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            String theNamespaceURI;
            theNamespaceURI = this.getNamespaceURI();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "namespaceURI", theNamespaceURI), currentHashCode, theNamespaceURI);
        }
        {
            String theName;
            theName = this.getName();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final SAMLAttributeDescriptor that = ((SAMLAttributeDescriptor) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "namespaceURI", lhsNamespaceURI), LocatorUtils.property(thatLocator, "namespaceURI", rhsNamespaceURI), lhsNamespaceURI, rhsNamespaceURI)) {
                return false;
            }
        }
        {
