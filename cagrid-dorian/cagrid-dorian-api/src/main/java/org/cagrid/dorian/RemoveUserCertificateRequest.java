...
@XmlRootElement(name = "RemoveUserCertificateRequest")
public class RemoveUserCertificateRequest
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof RemoveUserCertificateRequest)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final RemoveUserCertificateRequest that = ((RemoveUserCertificateRequest) object);
        {
