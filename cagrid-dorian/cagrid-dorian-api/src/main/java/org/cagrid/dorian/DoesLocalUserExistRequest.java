...
@XmlRootElement(name = "DoesLocalUserExistRequest")
public class DoesLocalUserExistRequest
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DoesLocalUserExistRequest)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DoesLocalUserExistRequest that = ((DoesLocalUserExistRequest) object);
        {
            String lhsUserId;
