...
@XmlRootElement(name = "RegisterLocalUserResponse")
public class RegisterLocalUserResponse
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof RegisterLocalUserResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final RegisterLocalUserResponse that = ((RegisterLocalUserResponse) object);
        {
            String lhsResponse;
