...
/**
 * <p>Java class for LocalUser complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LocalUser">
 *   &lt;complexContent>
 ...
 *         &lt;element name="state" type="{http://cagrid.nci.nih.gov/1/dorian-idp}stateCode" minOccurs="0"/>
 *         &lt;element name="zipcode" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="country" type="{http://cagrid.nci.nih.gov/1/dorian-idp}countryCode"/>
 *         &lt;element name="phoneNumber" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="status" type="{http://cagrid.nci.nih.gov/1/dorian-idp}LocalUserStatus"/>
 *         &lt;element name="role" type="{http://cagrid.nci.nih.gov/1/dorian-idp}LocalUserRole"/>
 *         &lt;element name="PasswordSecurity" type="{http://cagrid.nci.nih.gov/1/dorian-idp}PasswordSecurity"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "LocalUser", propOrder = {
    "userId",
    "email",
    "password",
    "firstName",
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    @XmlElement(name = "PasswordSecurity", required = true)
    protected PasswordSecurity passwordSecurity;
    ...
    /**
     * Gets the value of the passwordSecurity property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the passwordSecurity property.
     * 
     * @param value
     *     allowed object is
     *     {@link PasswordSecurity }
     *     
     */
    public void setPasswordSecurity(PasswordSecurity value) {
        this.passwordSecurity = value;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            PasswordSecurity thePasswordSecurity;
            thePasswordSecurity = this.getPasswordSecurity();
            strategy.appendField(locator, this, "passwordSecurity", buffer, thePasswordSecurity);
        }
        return buffer;
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            PasswordSecurity thePasswordSecurity;
            thePasswordSecurity = this.getPasswordSecurity();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "passwordSecurity", thePasswordSecurity), currentHashCode, thePasswordSecurity);
        }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final LocalUser that = ((LocalUser) object);
        {
            String lhsUserId;
        ...
        {
            PasswordSecurity lhsPasswordSecurity;
            lhsPasswordSecurity = this.getPasswordSecurity();
            PasswordSecurity rhsPasswordSecurity;
            rhsPasswordSecurity = that.getPasswordSecurity();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "passwordSecurity", lhsPasswordSecurity), LocatorUtils.property(thatLocator, "passwordSecurity", rhsPasswordSecurity), lhsPasswordSecurity, rhsPasswordSecurity)) {
                return false;
            }
        }
        return true;
