...
@XmlRootElement(name = "ApproveHostCertificateResponse")
public class ApproveHostCertificateResponse
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ApproveHostCertificateResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ApproveHostCertificateResponse that = ((ApproveHostCertificateResponse) object);
        {
