...
/**
 * <p>Java class for LocalUserFilter complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LocalUserFilter">
 *   &lt;complexContent>
...
@XmlType(name = "LocalUserFilter", propOrder = {
    "userId",
    "email",
    "firstName",
    "lastName",
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LocalUserFilter)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final LocalUserFilter that = ((LocalUserFilter) object);
        {
            String lhsUserId;
