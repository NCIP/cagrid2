...
@XmlRootElement(name = "GetPublishResponse")
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            boolean theResponse;
            theResponse = (true?this.isResponse():false);
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetPublishResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetPublishResponse that = ((GetPublishResponse) object);
        {
            boolean lhsResponse;
            lhsResponse = (true?this.isResponse():false);
            boolean rhsResponse;
            rhsResponse = (true?that.isResponse():false);
