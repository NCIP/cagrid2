...
/**
 * <p>Java class for BasicAuthCredential complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BasicAuthCredential">
 *   &lt;complexContent>
...
@XmlType(name = "BasicAuthCredential", propOrder = {
    "userId",
    "password"
})
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof BasicAuthCredential)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final BasicAuthCredential that = ((BasicAuthCredential) object);
        {
            String lhsUserId;
