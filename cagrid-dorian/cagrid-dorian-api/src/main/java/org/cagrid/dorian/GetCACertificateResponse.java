...
@XmlRootElement(name = "GetCACertificateResponse")
public class GetCACertificateResponse
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetCACertificateResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetCACertificateResponse that = ((GetCACertificateResponse) object);
        {
