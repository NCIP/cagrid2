...
public class Utils {
	...
	public static java.lang.Object concatenateArrays(Class<?> resultClass,
		...
		java.lang.Object newArray = Array.newInstance(resultClass,
				Array.getLength(arr1) + Array.getLength(arr2));
		System.arraycopy(arr1, 0, newArray, 0, Array.getLength(arr1));
		System.arraycopy(arr2, 0, newArray, Array.getLength(arr1),
	...
	public static java.lang.Object appendToArray(java.lang.Object array,
		...
		java.lang.Object newArray = Array.newInstance(arrayType,
	 ...
	 * @return
	 */
	public static java.lang.Object trimArray(java.lang.Object array,
...
//			public void serialize(QName elemQName, Attributes attributes,
//					Object value) throws IOException {
//				serialize(elemQName, attributes, value, null, Boolean.FALSE,
//						null);
//			}
//		};
...
//	}
	 ...
	 */
//	public static <T> T deserializeObject(Reader xmlReader, Class<T> clazz,
...
//	}
	...
	public static void stringBufferToFile(StringBuffer string, File file)
			throws IOException {
	...
	public static String encodeUrl(String url) {
		...
		String[] replace = { "%3B", "%3F", "%23", "%24", "%3D", "%2B", "%26",
				"%2C", "%20", "%3C", "%3E", "%7E" };
